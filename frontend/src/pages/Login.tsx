...
import { EnvelopeIcon, LockClosedIcon, ArrowRightOnRectangleIcon, ExclamationCircleIcon } from '@heroicons/react/24/outline';
...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-indigo-500/5 rounded-full blur-[100px]"></div>
                ...
                <div className="bg-white/2 backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-8 sm:p-10 shadow-2xl">
                        ...
                        <div className="space-y-4">
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-white placeholder:text-gray-600 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500/30 transition-all font-medium"
                                />
                            </div>
                            <div className="relative group">
                                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 transition-colors group-focus-within:text-blue-400">
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-gray-500 font-medium">
                            ...
                            <Link to="/register" className="text-white hover:text-blue-400 transition-colors font-bold">
                                Create Account
                            </Link>
                        </p>
                    </div>
