    ...
    return (
        <div className="fixed inset-0 z-[100] overflow-hidden">
            ...
            <div className="layout-container relative h-full">
                <div className="absolute top-24 right-6 w-full max-w-sm animate-fade-in-down overflow-hidden rounded-[2rem] border border-white/10 bg-[#111118]/95 shadow-2xl shadow-blue-500/20 backdrop-blur-3xl sm:right-10">
                    <div className="flex items-center justify-between border-b border-white/5 p-6 pb-4">
                        <h2 className="text-lg font-bold tracking-tight text-white">Categories</h2>
                        <button
                            onClick={onClose}
